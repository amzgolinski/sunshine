...
public class Utility {
  ...
  public static String getArtUrlForWeatherCondition(Context context,
                                                    int weatherId) {
  ...
  public static String getFormattedWind(Context context, float windSpeed,
    ...
    // (e.g NW) You know what's fun, writing really long if/else statements
    // with tons of possible conditions.  Seriously, try it!
  ...
  public static String getFullFriendlyDayString(Context context,
                                                long dateInMillis) {
  ...
  public static String getFriendlyDayString(Context context, long dateInMillis,
    ...
    if (displayLongToday && julianDay == currentJulianDay) {
      ...
      // If the input date is less than a week in the future, just return the
      // day name.
  ...
  /*
     * Helper method to provide the correct image according to the weather
     * condition id returned by the OpenWeatherMap call.
     *
     * @param weatherId from OpenWeatherMap API response
     * @return A string URL to an appropriate image or null if no mapping is
     * found
     */
  ...
  public static String getStringForWeatherCondition(Context context,
                                                    int weatherId) {
    // Based on weather code data found at:
    // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
    int stringId;
